...
export class SessionHandlerService {
  ...
  public setSession(deviceID : any, 
                    dsName : any, 
                    userID : any, 
                    password : any, 
    ...
    if (userID!="") {
      this.global.setCookie("UserID", userID, 15);//change to 15
    }
    if (password!="") {
      this.global.setCookie("PW", password, 15);//change to 15
    }
    if(lastNameFirstName!="")
    {
      this.global.setCookie("LastNameFirstName", lastNameFirstName, 15);//change to 15
    }
    if(isADLDS!="")
    {
